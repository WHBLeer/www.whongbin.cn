CREATE TABLE tx_timeline_domain_model_timelineevent (
    ...
    t3ver_label varchar(255) DEFAULT '0' NOT NULL,
...
CREATE TABLE tt_content (
    tx_timeline_timelineevents int(11) unsigned DEFAULT '0' NOT NULL
);